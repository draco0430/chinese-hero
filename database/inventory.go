...
var (
	...
	//SHOW_PET_BUTTON = utils.Packet{0xaa, 0x55, 0x50, 0x00, 0x59, 0x05, 0x0a, 0x00, 0x03, 0x06, 0x2f, 0x8a, 0x09, 0x01, 0x00, 0x00, 0xa4, 0x04, 0x00, 0x00, 0x00, 0x00, 0x32, 0x8a, 0x09, 0x01, 0x01, 0x00, 0xa4, 0x04, 0x00, 0x00, 0x00, 0x00, 0x30, 0x8a, 0x09, 0x01, 0x02, 0x00, 0xa4, 0x04, 0x00, 0x00, 0x00, 0x00, 0x21, 0x8a, 0x09, 0x01, 0x03, 0x00, 0xa4, 0x04, 0x00, 0x00, 0x00, 0x00, 0x31, 0x8a, 0x09, 0x01, 0x09, 0x00, 0xa4, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0xaa}
	...
	if slot.ItemID > 0 {
		...
		if item.GetType() == PET_TYPE { // pet
			...
			if item.GetType() == FILLER_POTION_TYPE {
				...
				if slot.Plus > 0 || slot.SocketCount > 0 || slot.Appearance != 0 { // item text color
					r[11] = 0xA2
				}
...
func (pet *PetSlot) PlayerAttack(owner *Character) []byte {
	resp := MOB_ATTACK
	mob, _ := FindCharacterByID(pet.Target)
